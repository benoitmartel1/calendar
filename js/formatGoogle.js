      ...
      var e,
        t = function(e, t) {
          ...
          n = e.items
            .filter(function(e) {
              return (
                e && e.hasOwnProperty("status") && "cancelled" !== e.status
              );
            })
            .sort(l)
            .reverse();
          ...
          p.firstChild &&
            ...
            d.firstChild && d.insertAdjacentHTML("beforebegin", t.pastHeading);
        },
        n = function(n) {
          e = n;
          var r = n.calendarUrl;
        ...
        i = function(t, n, r) {
          ...
          for (d = 0; d < r.length; d++)
            (r[d] = r[d].toString()),
              "*summary*" === r[d]
                ? (l = l.concat('<span class="summary">' + v + "</span>"))
                : "*date*" === r[d]
                ? (l = l.concat('<span class="date">' + f + "</span>"))
                : "*description*" === r[d]
                ? (l = l.concat('<span class="description">' + T + "</span>"))
                : "*location*" === r[d]
                ? (l = l.concat('<span class="location">' + y + "</span>"))
                : (("*location*" === r[d + 1] && "" !== y) ||
                    ("*summary*" === r[d + 1] && "" !== v) ||
                    ("*date*" === r[d + 1] && "" !== f) ||
                    ("*description*" === r[d + 1] && "" !== T)) &&
        ...
        v = function(t, n, r, a, o) {
          ...
          return (
            r && (s = d(t)),
            !e.sameDayTimes || a || o || (i = " from " + N(t) + " - " + N(n)),
            s + c(t[1]) + " " + t[0] + ", " + t[2] + i
          );
        },
        T = function(e, t, n) {
